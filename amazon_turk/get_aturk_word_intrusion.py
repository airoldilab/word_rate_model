...
outfilename_root = out_dir + "aturk_word_intrusion_t" + str(ntopics) + "_j" + str(njobs) + "_r" + str(nreplicates)
outfilename = outfilename_root + ".csv"
outfilename_ans = outfilename_root + "_ans.csv"
...
# Run script
gen_wi_csv(topic_sum_filenames_dict,outfilename,outfilename_ans,nwords_sum=5,nwords_sum_full=10, \
